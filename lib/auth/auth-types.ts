...
export function mapCredentialToLegacyType(credential: ProviderAuthCredential): LegacyCredentialType | "wellknown" | "aws-env-chain" {
...
export function credentialPrimarySecret(credential: ProviderAuthCredential): string {
  switch (credential.type) {
    case "api":
