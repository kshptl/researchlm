...
export const persistenceRepository = {
  ...
  async saveGeneratedSubtopicCandidate(
    record: GeneratedSubtopicCandidate,
  ): Promise<void> {
    await putRecord("generatedSubtopicCandidates", record);
  },
  async loadGeneratedSubtopicCandidates(
    workspaceId: string,
  ): Promise<GeneratedSubtopicCandidate[]> {
    const all = await getAllRecords<GeneratedSubtopicCandidate>(
  ...
  async loadRetryContext(
    requestId: string,
  ): Promise<RetryContextRecord | undefined> {
  ...
  async loadConflictEvents(
    workspaceId: string,
  ): Promise<ConflictEventRecord[]> {
